...
namespace Bipolar.PuzzleBoard.General
{
    public static class DirectionTileHelper
    {
        ...
        public static Vector2Int GetTileDirection(Vector2Int coord, DirectionTile tile, bool isHexagonal) => BoardHelper.GetCorrectedDirection(coord, tile.Direction, isHexagonal);
    }
}
